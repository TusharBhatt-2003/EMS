...
const CompleteTask = ({ data }) => {
  return (
    <>
    <div className='p-5 flex-shrink-0 h-fit md:h-full w-[70%] md:w-[300px] bg-green-600 rounded-xl'>
      ...
      <div className="mt-5 space-x-5">
        <button className="bg-blue-600 px-2 py-1 rounded-lg hover:bg-blue-800">Submit</button>
    </div>
    </div> 
    </>
  )
